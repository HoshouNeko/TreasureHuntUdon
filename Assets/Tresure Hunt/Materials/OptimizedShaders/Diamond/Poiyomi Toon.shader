Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/23637ed53b72a0344919a8e8804c7970"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.521 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.5529412).rgb, (0.0 /*_ColorThemeIndex*/));
